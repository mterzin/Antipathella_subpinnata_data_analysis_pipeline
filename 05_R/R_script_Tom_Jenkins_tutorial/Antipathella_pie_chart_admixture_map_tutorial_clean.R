...
setwd("~/Documents/Antipathella/R_script_Tom_Jenkins_validation/")
...
# Explore data
data_final_neutral2 # This is the genind object I obtained already in the previous script
nLoc(data_final_neutral2) # number of loci
nPop(data_final_neutral2) # number of sites
nInd(data_final_neutral2) # number of individuals
summary(data_final_neutral2$pop) # sample size
# I have monomorphic loci, so remove these first
informative_data_final <- informloci(data_final_neutral2)
...
pal_data = colorRampPalette(c("slategray4","lightsalmon3"))
...
save.image("~/Documents/Antipathella/R_script_Tom_Jenkins_validation/LEA_neutral_loci.RData")
